...
public class MouseLook : MonoBehaviour
{
    ...
    void Start()
    {
        Cursor.lockState = CursorLockMode.Locked;   // to remove mouse pointer and add crosshair
    ...
    void LookAround(){
        ...
        // current_Roll_Angle = Mathf.Lerp(current_Roll_Angle , Input.GetAxisRaw(MouseAxis.MOUSE_X) * roll_Angle ,
